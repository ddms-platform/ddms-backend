...
namespace DDMS.Backend.Migrations
{
    ...
    [Migration("20260819130402_ThemHangVeTheoDoTuoi")]
    partial class ThemHangVeTheoDoTuoi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.blog_post", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<DateTime?>("source_published_at")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<string>("video_script")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.booking", b =>
                {
                    ...
                    b.Property<DateTime?>("hold_expired_at")
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)");

                    b.Property<bool>("hold_reminder_sent")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false);
                    ...
                    b.HasIndex(new[] { "hold_expired_at" }, "idx_bookings_hold_expired");
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.dock_schedule", b =>
                {
                    ...
                    b.HasIndex(new[] { "dock_id", "berth_code" }, "idx_dock_schedules_berth");
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.owner_profile", b =>
                {
                    ...
                    b.Property<DateTime?>("document_upload_deadline")
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<DateTime?>("last_document_rejected_at")
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.sos_alert", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.tour", b =>
                {
                    ...
                    b.Property<decimal>("child_price_percent")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                    ...
                    b.Property<decimal>("infant_price_percent")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)")
            ...
            modelBuilder.Entity("DDMS.Backend.Models.Entities.boat_cabin", b =>
                {
                    ...
                    b.HasOne("DDMS.Backend.Models.Entities.tour", null)
                        .WithMany()
