...
public class AuthService : IAuthService
{
    ...
    public async Task<MessageResponse> UpdateProfileAsync(Guid userId, UpdateProfileRequest request)
    {
        var user = await _userRepository.GetByIdWithRolesAsync(userId);
        if (user is null)
        {
        ...
        return new MessageResponse { message = "Profile updated successfully" };
    }

    public async Task<MessageResponse> UpdateAvatarAsync(Guid userId, Microsoft.AspNetCore.Http.IFormFile file)
    {
        var user = await _userRepository.GetByIdWithRolesAsync(userId);
        if (user is null)
        {
        ...
        return new MessageResponse { message = "Avatar updated successfully" };
    }
